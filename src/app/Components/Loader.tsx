...
export default function Loader() {
    ...
    return (
        <div className={`fixed inset-0 w-full h-screen overflow-hidden z-[1000] bg-black ${isTransitioning ? 'translate-y-[-100%]' : 'translate-y-[0%]'} transition-transform delay-200 duration-700 ease-in-out`}>
            <div className="flex flex-col bg-black justify-center items-center h-full">
